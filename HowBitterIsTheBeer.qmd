...
ggplot(data = beerdf_new, aes(x = ibu)) +
  ...
  labs(title = "Histogram of IBU", x = "IBU", y = "Count") + scale_fill_brewer(palette = "Pastel1")
```
...
ggplot(data = beerdf_new, aes(y = ibu)) +
  geom_boxplot() +
  labs(title = "Boxplot of IBU", y = "IBU") + scale_fill_brewer(palette = "Pastel1")
```
...
srmpie <- ggplot(srmcategcounts, aes(x="", y=value, fill=group)) + geom_bar(width = 1, stat = "identity") + 
coord_polar("y") + 
scale_fill_brewer(palette = "Pastel1") + 
blank_theme + 
