...
Working with categorical in regards to linear regression is not always
...
Dimensions of beerdf_new is now 5,909x6
...
Dimensions of cleaned_data 5,707x6
...
Dimensions of our further cleaned data is 5,544x6
...
We will remove all srm observations with the string 'Over 40'
